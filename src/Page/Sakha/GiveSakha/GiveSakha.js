    ...
    return (
        <div className=' grid grid-cols-2 items-center mt-16 mb-6'>
            <div>
                ...
                <p>আপনি কি মেডুলা'স এর শাখা নিতে আগ্রহী ? তবে আজই যোগাযোগ করুন মেডুলা'স এর সাথে। আমরা দিচ্ছি সর্ত সাপেক্ষে সারা বাংলাদেশে শাখা নেয়ার সুযোগ। তাই দেরি নাহ করে আজই যোগাযোগ করুন আমদের সাথে। </p>
