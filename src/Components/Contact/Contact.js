                    ...
                    <div class="lg:flex lg:items-center lg:-mx-6">
                        <div class="lg:w-1/2 lg:mx-6">
                            <h1 class="text-3xl font-semibold text-gray-800 capitalize  lg:text-5xl">
                                বিস্তারিত জানতে আমদের সাথে যোগাযোগ করুন
                            </h1>

                            <div class="mt-6 space-y-8 md:mt-8">
                                <p class="flex items-start -mx-2">
                                    <svg xmlns="http://www.w3.org/2000/svg" class="w-6 h-6 mx-2 text-blue-500 dark:text-purple-600" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                                        <path stroke-linecap="round" stroke-linejoin="round" d="M17.657 16.657L13.414 20.9a1.998 1.998 0 01-2.827 0l-4.244-4.243a8 8 0 1111.314 0z" />
                                        <path stroke-linecap="round" stroke-linejoin="round" d="M15 11a3 3 0 11-6 0 3 3 0 016 0z" />
                                    </svg>

                                    <span class="mx-2 text-gray-700  w-72 ">
                                        খুলনা মেডিকেল (২৫০ বেড) এর সামনে,বয়রা,খুলনা
                                    </span>
                                </p>
                                ...
                                <p class="flex items-start -mx-2">
                                    ...
                                    <span class="mx-2 text-gray-700 text-lg truncate w-72 ">০১৯৭২৩৪৩৯২৫/০১৭২৫১২৮৩৮৭</span>
                                </p>
                            ...
                            <div class="mt-6 w-80 md:mt-8">
                                ...
                                <div class="flex mt-4 -mx-1.5 ">
                                    <a class="mx-1.5 dark:hover:text-purple-600 text-gray-400 transition-colors duration-300 transform hover:text-blue-500" href="https://www.facebook.com/medullasnursing" target='_blank'>
