...
const MidWifCourseC = () => {
    return (
        <div className=' max-w-7xl mx-auto px-5 pb-10'>
            <div className='py-10 text-center bg-gradient-to-r from-white via-lime-200  to-white'>
                <h1 className='text-4xl font-bold text-black '>ডিপ্লোমা ইন মিডওয়াইফারী নার্সিং ভর্তি প্রস্তুতি</h1>
                <div className=' text-2xl flex items-center px-2 mt-2 justify-center' >
                    <TbCurrencyTaka className=' text-3xl text-lime-600 font-bold -mt-1' />
                    <h1 className=' font-bold text-lime-600'>১৩,৫০০</h1>
                </div>
            </div>
            <div className=' py-10'>
                <div className=' flex items-center font-bold group gap-3 text-xl'>
                    <AiOutlineSave className=' text-lime-600 group-hover:text-lime-600 text-2xl -mt-1' />
                    <h1>ডিপ্লোমা ইন মিডওয়াইফারী নার্সিং ভর্তি প্রস্তুতি কোর্স বিবরণী:</h1>
                </div>
                <div className='w-full md:pl-[20%] py-5'>
                    <div>
                        <div className=' flex items-center text-lg gap-3'>
                            <AiOutlineSwitcher />
                            <h1>প্রথম পর্যায়ঃ <span className=' text-lime-600'>লেকচার</span></h1>
                        </div>
                        <div className=' mt-4'>
                            <div class="overflow-x-auto relative shadow-md sm:rounded-lg">
                                <table class="w-full text-sm text-center text-gray-500 ">
                                    <thead class=" text-gray-700 text-base uppercase   bg-gradient-to-r from-white via-lime-200 to-white ">
                                        <tr className='pb-3 '>
                                    ...
                                    <tbody>
                                        <tr class="bg-white hover:bg-lime-50 border-b border-t border-lime-300 text-base font-bold ">
                                    ...
                                    <thead class=" text-gray-700 uppercase  bg-gradient-to-r from-white via-lime-200 to-white ">
                                        <tr>
                    ...
                    <div className=' mt-10'>
                        <div className=' flex items-center text-lg gap-3'>
                            <AiOutlineSwitcher />
                            <h1>দ্বিতীয় পর্যায়ঃ <span className=' text-lime-600'>পেপার ফাইনাল</span></h1>
                        </div>
                        <div className=' mt-4'>
                            <div class="overflow-x-auto relative shadow-md sm:rounded-lg">
                                <table class="w-full text-sm text-center text-gray-500 ">
                                    <thead class=" text-gray-700 text-lg uppercase  bg-gradient-to-r from-white via-lime-200 to-white ">
                                        <tr>
                                            <th scope="col" class="py-2 px-6">
                                                বিষয়
                                            </th>
                    ...
                    <div className=' mt-10'>
                        <div className=' flex items-center text-lg gap-3'>
                            <AiOutlineSwitcher />
                            <h1>তৃতীয় পর্যায়ঃ<span className=' text-lime-600'> সাবজেক্ট ফাইনাল</span></h1>
                        </div>
                        <div className=' mt-4'>
                            <div class="overflow-x-auto relative shadow-md sm:rounded-lg">
                                <table class="w-full text-sm text-center text-gray-500 ">
                ...
                <div className=' mt-5'>
                    <div className=' flex items-center font-bold group gap-3 text-xl'>
                        <AiOutlineSave className=' text-lime-600 group-hover:text-lime-600 text-2xl -mt-1' />
                        <h1> ডিপ্লোমা ইন মিডওয়াইফারী নার্সিং পড়ার যোগ্যতা</h1>
                    </div>
                    <div className=' md:pl-[20%]'>
                        <div className=' flex items-center gap-3 mt-2 '>
                            <FaHandPointRight className='text-lime-600' />
                ...
                <div className=' mt-5'>
                    <div className=' flex items-center font-bold group gap-3 text-xl'>
                        <AiOutlineSave className=' text-lime-600 group-hover:text-lime-600 text-2xl -mt-1' />
                        <h1>ডিপ্লোমা ইন মিডওয়াইফারী নার্সিং ভর্তি পরীক্ষার মানবন্টন-</h1>
                    </div>
                    <div className=' mt-4  md:pl-[20%]'>
                        <div class="overflow-x-auto relative shadow-md sm:rounded-lg">
                            <table class="w-full text-sm text-center text-gray-500 ">
                                ...
                                <thead class=" text-gray-700 hover:bg-lime-50 uppercase  bg-gradient-to-r from-white via-lime-200 to-white ">
                                    <tr>
                                        <th scope="col" class="pt-2 pb-2.5 px-6">
                                            সর্বমোট
                                        </th>
