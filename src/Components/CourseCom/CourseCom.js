...
const CourseCom = () => {
    return (
        <div className=' max-w-7xl mx-auto px-5'>
            ...
            <div className='max-w-5xl mx-auto grid xl:grid-cols-2 md:grid-cols-2 grid-col-1 gap-10 mt-10'>
                <div className=' bg-white border hover:border-purple-600 transition-all duration-200 ease-in-out border-gray-500 pb-3 rounded-lg'>
                    ...
                    <div className=' px-4 flex items-center justify-between'>
                        <div>
                            <p>অফলাইনে সরাসরি ক্লাস।</p>
                            <p>১৫ টি স্পেশাল ক্লাস।</p>
                            <p>০১ টি গাইডলাইন ক্লাস।</p>
                        </div>
                        <div>
                            <p>১৫ টি এক্সট্রা ক্লাস।</p>
                            <p>১৫ টি রিভিউ ক্লাস।</p>
                            <p> ১০ টি সাবজেক্ট ফাইনাল ক্লাস।</p>
                        </div>
                    </div>
                </div>
