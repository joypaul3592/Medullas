    ...
    return (
        <div className=" h-full py-10  ">
            <div class=" bg-no-repeat h-full flex justify-center items-center">
                <div class="w-full max-w-[300px] border border-sky-500 p-8 rounded-xl text-gray-800 bg-no-repeat  overflow-hidden group hover:shadow-xl hover:shadow-sky-500/20 motion-safe:transition-all motion-safe:duration-700">
                    ...
                    <header class="motion-safe:translate-y-4 group-hover:translate-y-0 motion-safe:transition-transform motion-safe:transform-gpu motion-safe:duration-500">
                        ...
                        <p class="text-center group-hover:text-gray-50  relative">
                            খুলনা নার্সিং কলেজ, খুলনা
                        </p>
                    </header>

                    <ul class="flex justify-center space-x-4 mt-16 text-sky-500 relative">
                        <li class="motion-safe:translate-y-[100px] group-hover:translate-y-0 motion-safe:delay-100 motion-safe:transition">
                            <a href="#!" aria-label="Visit me on LinkedIn">
                                <svg
                        ...
                        <li class="motion-safe:translate-y-[100px] group-hover:translate-y-0 motion-safe:delay-200 motion-safe:transition">
                            <a href="#!" class="" aria-label="Visit me on Instagram">
                                <svg
                                    xmlns="http://www.w3.org/2000/svg"
                                    viewBox="0 0 448 512"
                                    class="h-6 w-6"
                        ...
                        <li class="motion-safe:translate-y-[100px] group-hover:translate-y-0 motion-safe:delay-300 motion-safe:transition">
                            <a href="#!" class="" aria-label="Send me a message">
                                <svg
                                    xmlns="http://www.w3.org/2000/svg"
                                    fill="none"
                                    viewBox="0 0 24 24"
