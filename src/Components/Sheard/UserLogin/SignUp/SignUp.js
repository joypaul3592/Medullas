                    ...
                    <div class="w-full bg-white rounded-2xl shadow dark:border md:mt-0 sm:max-w-md xl:p-0  dark:border-gray-700">
                        <div class="p-6 space-y-4 md:space-y-6 sm:p-8">
                            ...
                            <form class="space-y-4 md:space-y-6" action="#">
                                <div>
                                    <label for="text" class="block mb-2 text-sm font-medium text-gray-900 ">তোমার নাম</label>
                                ...
                                <div>
                                    <label for="email" class="block mb-2 text-sm font-medium text-gray-900 ">তোমার ইমেইল</label>
                                ...
                                <div>
                                    <label for="password" class="block mb-2 text-sm font-medium text-gray-900 ">তোমার পাসওয়ার্ড</label>
                                ...
                                <div class="flex items-center justify-between">
                                    <div class="flex items-start">
                                        ...
                                        <div class="ml-3 text-sm">
                                            <label for="remember" class="text-gray-500 ">মনে রাখো</label>
                                        </div>
                                    </div>
                                    <a href="#" class="text-sm font-medium text-gray-700 hover:underline dark:text-primary-500">পাসওয়ার্ড ভুলেগেছেন?</a>
                                </div>
                                <button type="submit"
                                ...
                                <p class="text-sm  text-gray-500 flex items-center gap-2 ">
                                    ইতিমধ্যেয়েই কি অ্যাকাউন্ট আছে? <div onClick={() => navigate('/login')} class=" text-gray-700 hover:underline dark:text-primary-500 font-semibold cursor-pointer ">লগ ইন</div>
                                </p>
                            </form>
                        </div>
                    </div>
