                        ...
                        <div class="p-6 space-y-4 md:space-y-6 sm:p-8">
                            ...
                            <form class="space-y-4 md:space-y-6" action="#">
                                ...
                                >
                                    ...
                                    <span class="relative text-[13px] font-semibold"> লগ ইন</span>
                                </button>

                                <p class="text-sm  text-gray-500 flex items-center gap-2 ">
                                    আপনার কি কোন অ্যাকাউন্ট নেই? <div onClick={() => navigate('/signup')} class=" text-gray-700 hover:underline dark:text-primary-500 font-semibold cursor-pointer ">সাইন আপ</div>
                                </p>
                            </form>
                        </div>
                    </div>
