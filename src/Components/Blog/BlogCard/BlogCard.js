            ...
            <div className='lg:grid lg:grid-cols-3 flex flex-col items-center gap-10   text-center'>
                ...
                <div class="max-w-sm bg-white border border-gray-200 rounded-lg shadow-md hover:scale-[1.02] transition-all duration-200 ease-in-out ">
                    ...
                    <div class="p-5">
                        ...
                        <p class="mb-3 font-normal text-gray-700 text-justify ">{blogDatas[3]?.details.slice(0, 250)}...</p>
                ...
                <div class="max-w-sm bg-white border border-gray-200 rounded-lg shadow-md hover:scale-[1.02] transition-all duration-200 ease-in-out ">
                    ...
                    <div class="p-5">
                        ...
                        <p class="mb-3 font-normal text-gray-700 text-justify ">{blogDatas[4]?.details.slice(0, 250)}...</p>
                ...
                <div class="max-w-sm bg-white border border-gray-200 rounded-lg shadow-md hover:scale-[1.02] transition-all duration-200 ease-in-out ">
                    ...
                    <div class="p-5">
                        ...
                        <p class="mb-3 font-normal text-gray-700 text-justify ">{blogDatas[5]?.details.slice(0, 250)}...</p>
